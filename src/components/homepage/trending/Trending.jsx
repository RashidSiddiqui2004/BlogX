    ...
    <div className="flex flex-col py-12 ">
      <div className="flex gap-5 justify-between mt-8 w-full max-md:flex-wrap max-md:max-w-full">
        <div className="flex text-start flex-col px-5 font-semibold max-md:max-w-full">
          ...
          <div className="mt-2 text-5xl text-start  space-around tracking-tight leading-12 text-black-800 max-md:max-w-full max-md:text-4xl max-md:leading-10">
      ...
      <div className="flex flex-col">
        <div
          className="justify-center self-end px-6 py-2 mt-5 text-base whitespace-nowrap rounded border border-solid border-zinc-800 border-opacity-40 text-zinc-800 max-md:px-10 max-md:mt-10 "
